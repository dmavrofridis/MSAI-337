...
if __name__ == "__main__":
    ...
    # D # --output_dir=files/data/output/d --model_type=xlm-roberta-large-finetuned-conll03-english --model_name_or_path=xlm-roberta-large-finetuned-conll03-english --train_file=files/data/output/woz.train_c.txt --do_train --validation_file=files/data/output/woz.test_c.txt --do_eval --save_total_limit 10 --num_train_epochs 10 --per_device_train_batch_size=2 --per_device_eval_batch_size=2
